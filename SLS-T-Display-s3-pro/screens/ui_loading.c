...
ui_Image_logo1 = lv_image_create(ui_loading);
lv_image_set_src(ui_Image_logo1, &ui_img_images_logo_png);
...
lv_obj_remove_flag( ui_Image_logo1, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
